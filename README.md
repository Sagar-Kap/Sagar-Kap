...
- [sagar-kap/frontend-photography](https://github.com/sagar-kap/frontend-photography) - A front end website for a photography shop. (3 days ago)
...
- [weburz/carousel](https://github.com/weburz/carousel) - Drop-in carousels for Nuxt 4 that make YouTube, Instagram, and TikTok embeds behave. (6 days ago)
- [weburz/particle-canvas](https://github.com/weburz/particle-canvas) - Zero-dependency animated particle canvas for Nuxt 4. Drop-in &lt;ParticleCanvas /&gt;  component — ~10KB minified / ~3KB gzipped, TypeScript-first. (1 week ago)


#### 📜 My recent blog posts

- [Running Ubuntu Headless on Pi4 from USB](https://www.sagarkapoor.eu/raspberry-pi4-headless-ubuntu-from-usb/) (4 years ago)
